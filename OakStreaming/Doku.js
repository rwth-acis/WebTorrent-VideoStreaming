...
function OakStreaming(OakName){
   var self = this;
      ...
      */ 
       ...
       * @param {Stream_Ticket} stream_ticket_object - An object that other OakStreaming instances can pass as an argument to their receive_stream method to download the video from this and other OakStreaming instances and/or a Web server.
       */
