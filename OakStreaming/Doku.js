...
function OakStreaming(OakName){
   var self = this;
      ...
      */ 
       ...
       * @param {string[]} [options.webTorrent_trackers] - Array of WebTorrent torrent tracker URLs (strings). One of these torrent trackers will be used to connect to other OakStreaming instances. The OakStreaming client will first try to connect to the torrent tracker URL at index 0 of the array, then to the URL at index 1 and so forth. 
