...
function OakStreaming(OakName){
   var self = this;
      ...
      */ 
       ...
       * @param {boolean} [stop_uploading_when_video_downloaded] - If this argument is true, all uploading to other OakStreaming instances is permanently canceled and all processing of the loadVideo method permanently stopped as soon as the video has been downloaded completely.
       */
